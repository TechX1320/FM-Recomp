...
typedef struct SpuDebugInfo {
    ...
    uint32_t sweep_active_channels;
...
typedef struct SpuVoiceState {
    ...
    int16_t  cur_vol_l;     /* live internal left volume */
    int16_t  cur_vol_r;     /* live internal right volume */
...
typedef struct SpuGlobalState {
    ...
    int16_t  main_cur_l;    /* live internal main volume left */
    int16_t  main_cur_r;    /* live internal main volume right */
...
typedef struct {
    ...
    int16_t  vol_l;    /* live signed 16-bit internal L volume */
    int16_t  vol_r;    /* live signed 16-bit internal R volume */
    uint8_t  active;
