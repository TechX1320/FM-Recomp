...
typedef struct CDROMDebugState {
    ...
    int pending_delay;
    int pending_phase;
    int pending_time_continues;
    int apv2_stock_mode;
    int apv2_probe_active;
    uint8_t apv2_total;
    uint8_t apv2_success;
    uint64_t apv2_probe_play_acks;
    uint64_t apv2_test04_count;
    uint64_t apv2_test05_count;
    int fm_apv2_bypass_enabled;
    int fm_apv2_bypass_applied;
    uint32_t fm_apv2_bypass_frame;
    uint32_t fm_apv2_bypass_seen_184;
    uint32_t fm_apv2_bypass_seen_188;
    uint32_t fm_apv2_bypass_seen_18c;
    uint32_t fm_ap_state;
    uint32_t fm_ap_timer;
    uint8_t fm_ap_response[8];
    uint32_t i_stat;
    int last_sector_lba;
